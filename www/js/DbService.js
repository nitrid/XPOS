angular.module('app.db', []).service('db',function($rootScope)
{
    ...
    function _PaymentSend()
    {
        ...
        let syncSerialPort = function(config, req, listAction)
        {
        ...
        let send_eot_signal = function(config)
        {
        ...
        let send_enq_signal = function(config)
        {
        ...
        let get_answer_from_terminal = function(config)
        {
            let response = {};
        ...
        let send_message = function(config)
        {
        ...
        let transaction_start = function(config)
        {
            try 
            {
                // Init
