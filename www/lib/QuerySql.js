var QuerySql = 
{
    ...
    StokKartTedarikciListeGetir : 
    {
        query : "SELECT " +
                ...
                "FROM ITEM_CUSTOMER WHERE ITEM_CODE = @ITEM_CODE ORDER BY ISNULL((SELECT TOP 1 CONVERT(nvarchar,[LDATE],104) + ' ' + CONVERT(nvarchar,[LDATE],8)  FROM [ITEM_PRICE] WHERE [ITEM_CODE] = @ITEM_CODE AND [CUSTOMER] = [CUSTOMER_CODE] AND [TYPE] = 1 ORDER BY LDATE DESC),0) DESC",
        param : ['ITEM_CODE:string|25']
    },
